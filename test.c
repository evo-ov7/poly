...
struct returnb { void (*r0)(uint_least32_t);};
struct main_nester_t { void (*r0)(uint_least8_t,uint_least16_t);};
struct main_nester_t main_nester(void (*nested)(struct returnb (*)(void *),void *),struct nested3_t (*nested3)(struct main_my_obj *));
...
void main_main(void) {
 ...
 p2=p2>>(p3&0x1f)|p2<<((uint_least8_t)32u-p3&0x1f);
 int5=p2;
 while(1){
  ...
  if(int5>2u){
   ...
   cool=cool+((uint_least16_t)2u*(uint_least16_t)6u-(uint_least16_t)3u)&0xffff;
  }
 }
 long6=(uint_least64_t)0u;
 float7=0.0f;
 signed8=~1u+1u&0xffffffff;
 double9=0.0;
 half=0.0f;
 tiny=0.0f;
 array=malloc(sizeof(uint_least32_t)*20u);
 ((uint_least32_t *)array)[main_id((uint_least16_t)1u)+(uint_least16_t)4u&0xffff]=1u;
